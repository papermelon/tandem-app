...
export function mockHandover(rangeLabel: string) {
  return {
    current_situation:
      "Ah Muay is 78, has mild dementia, and is recovering from a recent fall. The immediate focus is rehab attendance, medication refill, and keeping family context visible while Rachel is carrying most coordination.",
