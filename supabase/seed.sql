...
insert into public.care_recipients (id, care_circle_id, name, age, context, address, relationship, country, phone, care_profile)
values (
  'mum',
  'circle-mum',
  'Ah Muay',
  ...
  '{
    ...
    "updatedAt": "today",
    "sections": [
      {"label": "Food texture", "value": "Soft foods preferred", "notes": ["Avoid hard or crunchy food unless someone is supervising.", "Cut meat and fruit into small pieces."]},
      {"label": "Drinks", "value": "Warm water or milo", "notes": ["Encourage small sips during meals."]},
      {"label": "Mobility", "value": "Use walking stick outside", "notes": ["Hold her arm on stairs or wet floors."]},
      {"label": "Watch for", "value": "Dizziness, missed meals, new confusion", "notes": ["Add a note if symptoms appear after medication."]}
    ]
  }'::jsonb
)
on conflict (id) do update set
