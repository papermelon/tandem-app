  ...
  try {
    ...
    if (file instanceof File && file.size > 0) {
      ...
      const transcription = await client.audio.transcriptions.create({
        ...
        prompt:
          "This is a Singapore family caregiving voice note about Ah Muay, rehab, polyclinic, SGH, HDB EASE, AIC grants, transport, helpers, medication reminders, and family task handover."
      });
    ...
    const response = await client.responses.parse({
      ...
      input: [
        ...
        {
          role: "user",
          content: `Family members: lead caregiver, Ming, Lina. Care recipient: Ah Muay, 78, mild dementia, recent fall. ${
